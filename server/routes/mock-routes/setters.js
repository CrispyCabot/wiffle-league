...
router.route('/mock/leagues/create').post(authChecker, async (req, res) => {
...
router.route('/mock/leagues/delete').post(authChecker, async (req, res) => {
...
router.route('/mock/players/create').post(async (req, res) => {
...
router.route('/mock/players/login').post(async (req, res) => {
...
router.route('/mock/players/logout').post(async (req, res) => {
...
router.route('/mock/games/create').post(authChecker, async (req, res) => {
...
// Auth Setters
router.route('/mock/refresh_token').post((req, res) => {
