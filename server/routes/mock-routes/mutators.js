...
router.route('/mock/leagues/kick-player').put(authChecker, async (req, res) => {
...
router.route('/mock/leagues/add-player').put(authChecker, async (req, res) => {
...
router.route('/mock/leagues/edit-settings').put(authChecker, async (req, res) => {
...
router.route('/mock/league/:id/invite').put(authChecker, async (req, res) => {
...
router.route('/mock/players/update-profile').put(authChecker, async (req, res) => {
...
router.route('/mock/players/:id/selected-schedules/add').put(async (req, res) => {
...
router.route('/mock/players/:id/selected-schedules/remove').put(async (req, res) => {
  const playerId = req.params.id
  const leagueId = req.body.id
...
router.route('/mock/player/:id/notification/delete').put(async (req, res) => {
  const playerId = req.params.id
...
router.route('/mock/player/:id/notification/reorder').put(async (req, res) => {
  const playerId = req.params.id
...
router.route('/mock/player/:id/notification/collapse').put(async (req, res) => {
  const playerId = req.params.id
  const { notifications } = req.body
  await Players.findOneAndUpdate({_id: playerId}, { $set: { notifications: notifications } })
  player = await Players.findOne({_id: playerId})
...
router.route('/mock/player/:id/notification/league-invitation/accept').put(authChecker, async (req, res) => {
  const playerId = req.params.id
...
router.route('/mock/player/:id/notification/send').put(authChecker, async (req, res) => {
  const playerId = req.params.id
...
router.route('/mock/games/:id/update-score').put(authChecker, async (req, res) => {
...
router.route('/mock/games/:id/update-completed').put(authChecker, async (req, res) => {
  const gameId = req.params.id
...
router.route('/mock/game/:id/update-date-location').put(authChecker, async (req, res) => {
  const gameId = req.params.id
